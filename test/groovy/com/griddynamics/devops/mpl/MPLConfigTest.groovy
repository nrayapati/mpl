...
class MPLConfigTest {
  ...
  void test_set_invalid_sublevels_for_existing_config_values() throws Exception {
    ...
    assertThatExceptionOfType(MPLException.class)
      ...
      .withMessage('''Invalid config key path '<first3_value>.asd': object type 'class java.lang.String' is not suitable to set the nested variable''')
    assertThat(CFG.first3_value)
    ...
    assertThatExceptionOfType(MPLException.class)
      ...
      .withMessage('''Invalid config key path 'first1_level.<second2_value>.asd': object type 'class java.lang.Integer' is not suitable to set the nested variable''')
    ...
    assertThatExceptionOfType(MPLException.class)
      ...
      .withMessage('''Invalid config key path '<first3_value>.asd.asd': object type 'class java.lang.String' is not suitable to set the nested variable''')
    assertThat(CFG.first3_value)
      .as('Check that the simple string was not modified')
      .isEqualTo('test-value')
    ...
    assertThatExceptionOfType(MPLException.class)
      ...
      .withMessage('''Invalid config key path 'first1_level.<second2_value>.asd.asd': object type 'class java.lang.Integer' is not suitable to set the nested variable''')
    assertThat(CFG.'first1_level.second2_value')
      .as('Check that the simple number was not modified')
      .isEqualTo(312)
    ...
    assertThatExceptionOfType(MPLException.class)
      ...
      .withMessage('''Invalid config key path 'first1_level.second1_level.<third3_value>.-31': List key value is not a positive integer''')

    assertThatExceptionOfType(MPLException.class)
      .isThrownBy({ CFG.'first1_level.second1_level.third3_value.asd' = 22 })
      .withMessage('''Invalid config key path 'first1_level.second1_level.<third3_value>.asd': List key value is not a positive integer''')

    assertThatExceptionOfType(MPLException.class)
      .isThrownBy({ CFG.'first1_level.second1_level.third3_value.-31.asd' = 22 })
      .withMessage('''Invalid config key path 'first1_level.second1_level.<third3_value>.-31.asd': List key value is not a positive integer''')

    assertThatExceptionOfType(MPLException.class)
      .isThrownBy({ CFG.'first1_level.second1_level.third3_value.asd.asd' = 22 })
      .withMessage('''Invalid config key path 'first1_level.second1_level.<third3_value>.asd.asd': List key value is not a positive integer''')
  }
